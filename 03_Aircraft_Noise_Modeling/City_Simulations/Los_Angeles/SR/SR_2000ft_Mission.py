...
def main():  
    ...
    departure_location         = ['BUR','DIS']
    
    # coordinates for departure airport 
    departure_coord            = np.array([[34.1843,-118.36587],[33.81151,-117.9179886]]) 
    
    # destination airport location
    destination_location       = ['SNA','LAX']  
    
    # coordinates for destination airport 
    destination_coord          =  np.array([[33.6719,-117.886],[33.9348,-118.39678]])
    ...
    if RUN_NEW_MODEL_FLAG:   
        ...
        # SAVE RESULTS
        # -------------------------------------------------------------------------------------------
        filename          = 'SR_2000ft_mission_' + city + '_' +  departure_location[flight_no] + '_to_' + destination_location[flight_no] 
