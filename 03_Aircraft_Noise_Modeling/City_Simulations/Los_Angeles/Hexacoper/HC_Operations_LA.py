...
def main():           
    ...
    for i in range(len(LA_flight_data)):
        ...
        # mission analyses 
        mission = mission_setup(num_crtl_pts, analyses, radius_Vert1, radius_Vert2, dep_heading, app_heading, dep_sector, app_sector, path_heading, total_cruise_distance,cruise_altitude)        
