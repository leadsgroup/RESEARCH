...
def main():  
    ...
    microphone_terrain_data    = Data(ground_microphone_x_resolution          = 31  ,
                                      ground_microphone_y_resolution          = 31  ,   
                                      ground_microphone_min_x                 = -0.5 * Units.nmi ,                 
                                      ground_microphone_max_x                 = 1.5 * Units.nmi ,
    ...
    for flight_no in range(len(departure_angles)):
        ...
        if RUN_NEW_MODEL_FLAG:   
            ...
            # SAVE RESULTS
            # -------------------------------------------------------------------------------------------
            filename          = 'TR_TG_Noise_Angle_' + str(departure_angles[flight_no]) 
