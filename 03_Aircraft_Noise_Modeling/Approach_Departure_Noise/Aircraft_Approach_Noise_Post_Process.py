...
def main():            
    ...
    filename_list = ['HC_Analyzed_Noise', 'TR_Analyzed_Noise', 'TSR_Analyzed_Noise']
    processed_filenames =  []
    for i,  analyzed_filename in enumerate(filename_list):        
        ...
        processed_filename = aircraft_codes[i]  +  '_Processed_Noise'
        processed_filenames.append(processed_filename)
        save(processed_results, processed_filename + '.res') 
        
        F =  Data(filename_list=processed_filenames)
        postprocessed_filename_name = 'Postprocessed_Noise' 
