...
def main():  
    ...
    for i in  range(len(aircraft_models)):
        # Read in results
        filename = relative_path +  '..' + separator +  'City_Simulations' + separator + 'Los_Angeles' + separator +'Tiltrotor' + separator + 'Cumulative4_' + aircraft_models[i] + '_'+ city +'_' +altitudes[0] +'ft.res'
