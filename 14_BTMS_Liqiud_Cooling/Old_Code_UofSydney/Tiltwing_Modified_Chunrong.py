...
# from SUAVE.Methods.Weights.Buildups.eVTOL.empty_hydra                           import empty_hydra as empty  # by Verstraete
...
from SUAVE.Methods.Weights.Buildups.eVTOL.converge_evtol_weight                 import converge_evtol_weight  # by Verstraete
from SUAVE.Plots.Geometry                                                       import *
#from SUAVE.Plots.Performance.Mission_Plots_Dries                                import *
...
def base_analysis(vehicle, N_gm_x, N_gm_y, min_y, max_y, min_x, max_x, aircraft_range, run_noise_model, hover_noise_test):
    ...
    if run_noise_model:
        # ------------------------------------------------------------------
        #  Noise Analysis
        noise                                   = SUAVE.Analyses.Noise.Fidelity_Zero()
...
def vehicle_setup():
    ...
    if air_cooled:
        ...
        bat                                         = SUAVE.Components.Energy.Storages.Batteries.Constant_Mass.Lithium_Ion_LiNiMnCoO2_18650_liquid()
    ...
    if not bat.air_cooled:
        btms                                                = SUAVE.Components.Energy.Cooling.WavyChan_GasLiqHEX()
    ...
    rel_path                                    = os.path.dirname(ospath) + separator + '..' + separator + 'Suave' + separator + 'regression' + separator + 'scripts' + separator + 'Vehicles' 
