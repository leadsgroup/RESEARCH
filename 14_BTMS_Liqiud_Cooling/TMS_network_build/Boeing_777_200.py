...
def vehicle_setup():
    ...
    #  Turbofan Network
    #-------------------------------------------------------------------------------------------------------------------------   
    net                                         = RCAIDE.Framework.Networks.Conventional_Network()
    net.tag                                     = 'Turbofan Network'  
    ...
    fuel_line1                                  = RCAIDE.Library.Components.Energy.Distribution.Fuel_Line()
    # Append fuel line to Network      
    net.distribution_lines.append(fuel_line)
    net.distribution_lines.append(fuel_line1) 
    ...
    #------------------------------------------------------------------------------------------------------------------------- 
    # fuel tank
    fuel_tank1                                   = RCAIDE.Library.Components.Energy.Fuel_Tanks.Fuel_Tank()
    fuel_tank1.origin                            = wing.origin
    fuel_tank1.tag                               = 'b777_fuel_tank2'
    ...
    # Create Network
    components =  [turbofan, turbofan_2, fuel_tank]
    net.create_propulsion_network(components, fuel_line)
    net.create_propulsion_network([fuel_tank1, turbofan], fuel_line1)
