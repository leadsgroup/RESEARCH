...
def main(): 
    ...
    variables = [
        ('Cycle Day [cruise_bus]', 'Cell SOC (%) [power_bus]', 'LFP SOC vs Time'),
        ('Cycle Day [cruise_bus]' ,'Cell SOC (%) [cruise_bus]', 'NMC SOC vs Time'),
        # ('Cycle Day', 'Resistance Growth', 'Resistance Growth vs Cycle Day'),
         ('Cycle Day [power_bus]', 'Capacity Fade [power_bus]', 'Capacity Fade LFP vs Cycle Day'),
        ('Cycle Day [cruise_bus]', 'Capacity Fade [cruise_bus]', 'Capacity Fade NMC vs Cycle Day'),
