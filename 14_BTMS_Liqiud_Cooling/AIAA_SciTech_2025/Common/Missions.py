...
# ------------------------------------------------------------------
def repeated_flight_operation_setup(configs,analyses,day_group,g_idx,group,days_per_group, flights_per_day ,charge_througput):
        ...
        for f_idx in range(flights_per_day):
            ...
            if group != 1 and  d_idx ==  0:
                try:
                    ...
                    raise Exception(f"Error: The key '{group-1}' was not found in charge_througput Run the simulation for the previous day group.")
