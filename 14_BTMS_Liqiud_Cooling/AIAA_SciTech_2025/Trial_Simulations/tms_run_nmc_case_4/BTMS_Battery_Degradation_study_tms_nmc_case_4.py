...
def main():  
    ...
    if RUN_NEW_MODEL_FLAG:    
        for g_idx, group  in  enumerate(day_group):
            ...
            # SAVE RESULTS
            # -------------------------------------------------------------------------------------------
            filename          = 'e_Twin_Otter_nmc_case_4_'
...
def save_results(results, filename, group):
   # Pickle Backup Files
    save_dir = '/home/sshekar2/storage/tms_degradation_11_19/case_4'
...
def load_charge_throughput(filename='previous_day_data'):
    load_dir = '/home/sshekar2/storage/tms_degradation_11_19/case_4'
