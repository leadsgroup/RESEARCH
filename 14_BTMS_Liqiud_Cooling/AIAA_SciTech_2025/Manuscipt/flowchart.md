```mermaid
graph TD
A([TMS Heat Removal Ability]):::whiteBox-->|Effects|B1([Power Consumption]):::whiteBox
...
B1-->|Drawn From|D([Battery]):::whiteBox
C2-->|Drawn From|D
...
G -->|"Temperature > 50°C"| H1([End - Thermally Limited]):::whiteBox
