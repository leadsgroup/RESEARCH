...
def vehicle_setup(BTMS_flag): 
   ...
   #------------------------------------------------------------------------------------------------------------------------------------  
    ...
    power_bus.propulsors.append(starboard_propulsor) 
...
def configs_setup(vehicle):
    ...
    config.tag                                            = 'lfp_operation'
    config_propulsor                                      = config.networks.electric.busses.cruise_bus
    config_propulsor.active                               = False
    config_propulsor.active                = False
    configs.append(config)  
     
    
    config                                                = RCAIDE.Library.Components.Configs.Config(vehicle) 
    config.tag                                            = 'nmc_operation'
    config_propulsor                                      = config.networks.electric.busses.power_bus
    config_propulsor.active                               = False
    config_propulsor.active                = False
    configs.append(config)  
