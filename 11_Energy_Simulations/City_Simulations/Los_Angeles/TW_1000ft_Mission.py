...
def main():  
    ...
    destination_coord          = np.array([[34.0758,-117.2512], [34.04920,-117.59908],  [34.04920,-117.59908], [34.1843,-118.36587],
                                           [33.81151,-117.9179886], [33.81151,-117.9179886], [34.0758,-117.2512], [34.1843,-118.36587], [34.0758,-117.2512]])
    ...
    if RUN_NEW_MODEL_FLAG:   
        ...
        # SAVE RESULTS
        # -------------------------------------------------------------------------------------------
        filename          = 'TW_1000ft_mission_' + city + '_' +  departure_location[flight_no] + '_to_' + destination_location[flight_no] 
