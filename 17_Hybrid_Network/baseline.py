...
def vehicle_setup():
    ...
    rel_path                                   = ospath.split( 'baseline.py')[0]   +  '..' + separator   
    ...
    # Turbine Propulsor
    #------------------------------------------------------------------------------------------------------------------------------------   
    turboelectric_generator                              = RCAIDE.Energy.Propulsors.Turboelectric_Generator()  
    turboelectric_generator.tag                          = 'turboelectric_generator'   
    turboelectric_generator.active_fuel_tanks            = ['tank_1']    
    turboelectric_generator.engine_length                = 4.039
    turboelectric_generator.nacelle_diameter             = 1.3
    turboelectric_generator.inlet_diameter               = 1.212 
    turboelectric_generator.areas.wetted                 = 30
    turboelectric_generator.design_altitude              = 60000.0*Units.ft
    turboelectric_generator.design_mach_number           = 2.02
    turboelectric_generator.design_thrust                = 40000. * Units.lbf  
    turboelectric_generator.origin                       = [[37.,6.,-1.3]] 
    turboelectric_generator.working_fluid                = RCAIDE.Attributes.Gases.Air()
    
    # Ram  
    ram     = RCAIDE.Energy.Propulsors.Converters.Ram()
    ram.tag = 'ram' 
    turboelectric_generator.append(ram) 
    ...
    turboelectric_generator.append(inlet_nozzle)     
    ...
    turboelectric_generator.append(compressor)       
    ...
    turboelectric_generator.append(turbine)        
    ...
    turboelectric_generator.append(combustor) 
    ...
    turboelectric_generator.append(nozzle) 
    
    # design turbojet 
    design_turbojet(turboelectric_generator)  
    ...
    generator.rotor_radius                    = propeller.tip_radius
    generator.design_torque                   = propeller.cruise.design_torque
    generator.angular_velocity                = propeller.cruise.design_angular_velocity 
    generator                                 = design_motor(generator)  
    generator.mass_properties.mass            = nasa_motor(generator.design_torque)  
    turboelectric_generator.append(generator)
    
    # append turbojet    
    fuel_line.propulsors.append(turboelectric_generator) 
    ...
    fuel_tank.fuel_selector_ratio                  = 1
