...
def main():
    ...
    for p_i in  range(len(propellants)):
        ...
        df.to_csv(propellants[p_i] + '_EmissionsA220.csv', index=False)       
...
def vehicle_setup(propellant): 
    ...
    landing_gear.main_tire_diameter = 0.5334 * Units.m
    landing_gear.nose_tire_diameter = 0.3048 * Units.m
    landing_gear.main_strut_length  = 1.8 * Units.m ## Fix
    landing_gear.nose_strut_length  = 1.3 * Units.m ## Fix
