...
from RCAIDE.Plots.Performance.Weights_Plots import weight_pie_charts
...
def main():
    ...
    #weight_pie_charts(problem.vehicle_configurations.base,problem.analyses.base)
    
    #Plot_Mission.plot_weights(problem)
    ...
    print(problem.results.hover.segments.hover_oei.conditions.propulsion.throttle)     
