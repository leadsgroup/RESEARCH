...
#from RCAIDE.Plots.Performance.Weights_Plots import *
...
def plot_mission(nexus):
    ...
    plot_propeller_conditions(results_range)

    # Plot Electric Motor and Propeller Efficiencies
    plot_eMotor_Prop_efficiencies(results_range)

    # Plot propeller Disc and Power Loading
    #plot_disc_power_loading(results_range)
...
def plot_weights(nexus,line_style='bo-'):
    
    vehicle  = nexus.vehicle_configurations.base
    analyses = nexus.analyses.base

    weight_pie_charts(vehicle, analyses)