...
def base_analysis(vehicle):
    ...
    # ------------------------------------------------------------------
    #  Weights
    weights = RCAIDE.Analyses.Weights.Weights_BWB()
...
def vehicle_setup():
    ...
    section_1_airfoil = RCAIDE.Components.Airfoils.Airfoil()
    ...
    section_2_airfoil = RCAIDE.Components.Airfoils.Airfoil()
    ...
    section_3_airfoil = RCAIDE.Components.Airfoils.Airfoil()
    ...
    section_4_airfoil = RCAIDE.Components.Airfoils.Airfoil()
    ...
    section_5_airfoil = RCAIDE.Components.Airfoils.Airfoil()
    ...
    section_6_airfoil = RCAIDE.Components.Airfoils.Airfoil()
    ...
    segment.thickness_to_chord    = 0.10
    section_7_airfoil = RCAIDE.Components.Airfoils.Airfoil()
    ...
    control_systems=RCAIDE.Components.Physical_Component()
    vehicle.control_systems=control_systems
    
    electrical_systems=RCAIDE.Components.Physical_Component()
    vehicle.electrical_systems=electrical_systems
    
    avionics=RCAIDE.Components.Energy.Peripherals.Avionics()
    vehicle.avionics=avionics
    
    passengers=RCAIDE.Components.Physical_Component()
    vehicle.passenger_weights=passengers
    
    furnishings=RCAIDE.Components.Physical_Component()
    vehicle.furnishings=furnishings
    
    air_conditioner=RCAIDE.Components.Physical_Component()
    vehicle.air_conditioner=air_conditioner
    
    fuel=RCAIDE.Components.Physical_Component()
    vehicle.fuel=fuel
    
    apu=RCAIDE.Components.Physical_Component()
    vehicle.apu=apu
    
    hydraulics=RCAIDE.Components.Physical_Component()
    vehicle.hydraulics=hydraulics
    
    optionals=RCAIDE.Components.Physical_Component()
