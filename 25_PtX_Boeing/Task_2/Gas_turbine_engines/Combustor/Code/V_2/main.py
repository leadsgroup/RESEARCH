...
def main():
    ...
    ti                      = time.time()                                                             # [s]       Initial simulation time
    ...
    combustor_input['m_dot_air']         = combustor_input['m_dot_air_tot']/combustor_input['N_comb'] # [kg/s]    Air mass flow inside each combustor
    combustor_input['m_dot_fuel']        = combustor_input['m_dot_fuel_tot']/combustor_input['N_comb']# [kg/s]    Fuel mass flow inside each combustor      
    ...
    output                  = pd.DataFrame(columns=col_names)                                          # [-]       Assign variables to output
