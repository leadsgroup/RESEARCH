...
def turboprop_model():
    ...
    fig11    =  plt.figure(r'$F_{\dot{m_0}}$ vs real')
    fig11.set_size_inches(7, 6)
    axis_11 = fig11.add_subplot(1,1,1)
    axis_11.plot(pi_c,F_mdot0_i[:,0], label=r'$\tau_t$ ideal: 0.4', color = 'b', linestyle = '--')
    axis_11.plot(pi_c,F_mdot0_r[:,0], label=r'$\tau_t$ real: 0.4',  color = 'b', linestyle = '-')
    axis_11.plot(pi_c,F_mdot0_i[:,1], label=r'$\tau_t$ ideal: 0.5', color = 'm', linestyle = '--') 
    axis_11.plot(pi_c,F_mdot0_r[:,1], label=r'$\tau_t$ real: 0.5',  color = 'm', linestyle = '-') 
    axis_11.plot(pi_c,F_mdot0_i[:,2], label=r'$\tau_t$ ideal: 0.6', color = 'c', linestyle = '--') 
    axis_11.plot(pi_c,F_mdot0_r[:,2], label=r'$\tau_t$ real: 0.6',  color = 'c', linestyle = '-') 
    axis_11.plot(pi_c,F_mdot0_i[:,3], label=r'$\tau_t$ ideal: 0.7', color = 'k', linestyle = '--') 
    axis_11.plot(pi_c,F_mdot0_r[:,3], label=r'$\tau_t$ real: 0.7',  color = 'k', linestyle = '-') 
    ...
    axis_11.set_ylabel('$F_{\dot{m_0}}$ [N/(kg/sec)]')
    axis_11.legend()
    ...
    axis_12.plot(pi_c,S_i[:,0], label=r'$\tau_t$ ideal: 0.4', color = 'b', linestyle = '--')
    axis_12.plot(pi_c,S_r[:,0], label=r'$\tau_t$ real: 0.4',  color = 'b', linestyle = '-')
    axis_12.plot(pi_c,S_i[:,1], label=r'$\tau_t$ ideal: 0.5', color = 'm', linestyle = '--') 
    axis_12.plot(pi_c,S_r[:,1], label=r'$\tau_t$ real: 0.5',  color = 'm', linestyle = '-') 
    axis_12.plot(pi_c,S_i[:,2], label=r'$\tau_t$ ideal: 0.6', color = 'c', linestyle = '--') 
    axis_12.plot(pi_c,S_r[:,2], label=r'$\tau_t$ real: 0.6',  color = 'c', linestyle = '-') 
    axis_12.plot(pi_c,S_i[:,3], label=r'$\tau_t$ ideal: 0.7', color = 'k', linestyle = '--') 
    axis_12.plot(pi_c,S_r[:,3], label=r'$\tau_t$ real: 0.7',  color = 'k', linestyle = '-') 
