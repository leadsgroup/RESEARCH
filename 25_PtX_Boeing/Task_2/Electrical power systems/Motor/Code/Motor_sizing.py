...
def emrax_348():
    ...
    L_d_1 = L_l + (3/2)*L_m                                               # direct axis inductance (Eq.56)
    ...
    #L_d                        = ((Slots*Layers)/(2*N_p))*(3cmf/2)*(N**2)*((2*A_tip*mu_0/l_tip + (3/2)*(W_sp*Stack*mu_0)/(l_m + l_g))) # direct axis inductance (Eq.57)
