...
def vehicle_setup(): 
    ...
    vehicle.mass_properties.max_takeoff               = 63100 * Units.kilogram  
    vehicle.mass_properties.takeoff                   = 60000 * Units.kilogram    
    vehicle.mass_properties.max_zero_fuel             = 52200 * Units.kilogram 
    vehicle.mass_properties.cargo                     = 3629  * Units.kilogram  
    vehicle.envelope.ultimate_load                    = 3.75                   
    vehicle.envelope.limit_load                       = 2.5 
    vehicle.reference_area                            = 112.3 * Units['meters**2']   
    vehicle.passengers                                = 135                       # No flight crew included
    vehicle.mass_properties.operating_empty           = (vehicle.mass_properties.max_zero_fuel - (90 * vehicle.passengers) - vehicle.mass_properties.cargo) * Units.kilogram 
    ...
    wing.tag                              = 'main_wing' 
    wing.aspect_ratio                     = (35.1**2)/vehicle.reference_area
    wing.sweeps.quarter_chord             = 22.2 * Units.deg                     #28.02 
