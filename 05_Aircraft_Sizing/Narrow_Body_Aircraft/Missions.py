...
def setup(analyses):
    ...
    OEI_mission_111c_1 = OEI_mission_setup_111c_1(analyses)
    missions.OEI_111c_1 = OEI_mission_111c_1        
    
    OEI_mission_111c_2 = OEI_mission_setup_111c_2(analyses)
    missions.OEI_111c_2 = OEI_mission_111c_2
    
    OEI_mission_121_1 = OEI_mission_setup_121_1(analyses)
    missions.OEI_121_1 = OEI_mission_121_1        
    
    OEI_mission_121_2 = OEI_mission_setup_121_2(analyses)
    missions.OEI_121_2 = OEI_mission_121_2    
    
    Aborted_landing_AEO_mission_119_1 = Aborted_landing_AEO_mission_setup_119_1(analyses)
    missions.Aborted_landing_AEO_119_1 = Aborted_landing_AEO_mission_119_1
    
    Aborted_landing_AEO_mission_119_2 = Aborted_landing_AEO_mission_setup_119_2(analyses)
    missions.Aborted_landing_AEO_119_2 = Aborted_landing_AEO_mission_119_2   
    
    Aborted_landing_OEI_mission_121d_1 = Aborted_landing_OEI_mission_setup_121d_1(analyses)
    missions.Aborted_landing_OEI_121d_1 = Aborted_landing_OEI_mission_121d_1
    
    Aborted_landing_OEI_mission_121d_2 = Aborted_landing_OEI_mission_setup_121d_2(analyses)
    missions.Aborted_landing_OEI_121d_2 = Aborted_landing_OEI_mission_121d_2 
...
def OEI_mission_setup_121_1(analyses, vehicle):
    ...
    segment.altitude_start                               = 0.0   * Units.km
    segment.altitude_end                                 = 0.001 * Units.km
...
def Aborted_landing_OEI_mission_setup_121d_1(analyses, vehicle):
    ...
    # VSTALL Calculation
    vehicle_mass   = vehicle.mass_properties.max_takeoff*0.8
    reference_area = vehicle.reference_area
    Vstall         = estimate_stall_speed(vehicle_mass,reference_area,altitude = 0.0,maximum_lift_coefficient = 1.2)
    ...
    # ------------------------------------------------------------------
    #  B First Climb Segment: Constant Speed, Constant Throttle
    # ------------------------------------------------------------------

    segment = Segments.Climb.Constant_Speed_Constant_Rate(base_segment)
    segment.tag = "reserve_climb_b" 
    segment.analyses.extend( analyses.takeoff ) 
    segment.altitude_start = 1500    * Units.km
    segment.altitude_end   = 15000. * Units.ft
    segment.air_speed      = 138.0  * Units['m/s']
    segment.climb_rate     = 3000.  * Units['ft/min']
