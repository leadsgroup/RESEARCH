...
from RCAIDE.Methods.Energy.Propulsors.Turbofan_Propulsor   import design_turbofan
...
def mission_setup(analyses):
    ...
    segment.altitude_end      = 22600 * Units.feet
    segment.climb_rate        = 7.4   * Units['m/s']  
    segment.air_speed_start   = 208 * Units['mph']
    segment.air_speed_end     = 550 * Units['mph']    
    ...
    segment.air_speed      = 550 * Units['mph']    
    segment.climb_rate     = 7.4   * Units['m/s']  
    ...
    mission.append_segment(segment).Clm
    ...
    segment.air_speed                                     = 550 * Units['mph']    
    segment.distance                                      = 1611.75 * Units.nmi   
    ...
    segment.analyses.extend( analyses.cruise )  
    segment.altitude_end      = 0.0
    segment.descent_rate      = 4.4  * Units.m / Units.s
    segment.air_speed_start   = 550 * Units['mph']  
    segment.air_speed_end     = 155 * Units['mph']    
