# tutorial_template_kk.py

# Created:  sept 2023 Koushik
# Modified: 
# ----------------------------------------------------------------------
#   Imports
# ----------------------------------------------------------------------
...
def main():
    ...
    # estimate Cg location using
    cg_location = compute_component_centers_of_gravity(vehicle)
    
    # Print the computed center of gravity location
    print("Center of Gravity Location (X, Y, Z):", cg_location)    
