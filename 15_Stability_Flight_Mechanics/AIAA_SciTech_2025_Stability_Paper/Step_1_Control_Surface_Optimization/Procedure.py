...
def elevator_sizing_post_process(nexus): 
    ...
    stability_pull_maneuver.settings.use_surrogate = False 
    stability_pull_maneuver.initialize()
    
    # ------------------------------------------------------------------------------------------------------------------------  
    # Run VLM   
    pull_up_state            = State() 
    pull_up_state.conditions =  pull_up_conditions
    stability_pull_maneuver.evaluate(pull_up_state)
    compute_dynamic_flight_modes(pull_up_state,stability_pull_maneuver.settings,vehicle)
    ...
    stability_push_maneuver.settings.use_surrogate = False 
    stability_push_maneuver.initialize()
     
    # ------------------------------------------------------------------------------------------------------------------------  
    # Run VLM   
    push_over_state            = State() 
    push_over_state.conditions =  pull_up_conditions
    stability_push_maneuver.evaluate(push_over_state)
    compute_dynamic_flight_modes(push_over_state,stability_push_maneuver.settings,vehicle)
...
def aileron_rudder_sizing_post_process(nexus):  
    ...
    stability_roll_maneuver.settings.use_surrogate = False 
    stability_roll_maneuver.initialize()
 
    # ------------------------------------------------------------------------------------------------------------------------  
    # Run VLM   
    roll_state            = State() 
    roll_state.conditions =  roll_conditions
    stability_roll_maneuver.evaluate(roll_state)
    ...
    # ------------------------------------------------------------------------------------------------------------------------  
    # Run VLM   
    crosswind_state            = State() 
    crosswind_state.conditions =  crosswind_conditions
    crosswind_maneuver.evaluate(crosswind_state) 
...
def flap_sizing_post_process(nexus): 
    ...
    stability_no_flap.use_surrogate = False 
    stability_no_flap.initialize()  
     
    # ------------------------------------------------------------------------------------------------------------------------  
    # Run VLM   
    no_flap_state            = State() 
    no_flap_state.conditions =  no_flap_conditions
    stability_no_flap.evaluate(no_flap_state)    
    ...
    stability_w_flap.use_surrogate = False 
    stability_w_flap.initialize()  
     
    # ------------------------------------------------------------------------------------------------------------------------  
    # Run VLM   
    w_flap_state            = State() 
    w_flap_state.conditions = w_flap_conditions
    stability_w_flap.evaluate(w_flap_state)    
