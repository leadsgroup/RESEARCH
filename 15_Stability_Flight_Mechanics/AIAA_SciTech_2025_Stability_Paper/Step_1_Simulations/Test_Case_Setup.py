...
from   Navion.Navion                                                      import vehicle_setup as Navion_vehicle_setup   
# ----------------------------------------------------------------------
#   Main
# ----------------------------------------------------------------------
...
def main():  
    ...
    size_control_surfaces(0, 0, case_vehicle, cruise_velocity, cruise_altitude)
