...
#   Build the Vehicle
# ----------------------------------------------------------------------
def vehicle_setup(resize_aircraft,vehicle_name = 'Joby_S4_CRM') :
    ...
    if resize_aircraft:
        ...
        prop_rotor.hover.design_thrust               = Hover_Load/(net.number_of_rotor_engines) 
        ...
        prop_rotor.oei.design_thrust                 = Hover_Load/(net.number_of_rotor_engines-2)  
