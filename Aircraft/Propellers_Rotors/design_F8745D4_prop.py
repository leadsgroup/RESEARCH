...
def design_F8745D4_prop():  
    ...
    airfoil.coordinate_file          = rel_path +'..' + separator + 'Airfoils' + separator + 'Clark_y.txt'
    airfoil.polar_files              = [rel_path +'..' + separator + 'Airfoils' + separator + 'Polars' + separator +'Clark_y_polar_Re_50000.txt' ,
