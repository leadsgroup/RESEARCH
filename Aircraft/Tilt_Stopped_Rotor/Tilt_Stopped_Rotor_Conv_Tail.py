...
def base_analysis(vehicle):
    ...
    stability.settings.drag_coefficient_increment = 0.0000
...
def vehicle_setup(redesign_rotors=True) : 
    ...
    for module in prop_rotor_bus.battery_modules:
        L = module.length
        W = module.width 
        H = module.height
        module.mass_properties.center_of_gravity ==  [[L/2,W/2,H/2]]
    ...
    for module in lift_rotor_bus.battery_modules:
        L = module.length
        W = module.width 
        H = module.height
        module.mass_properties.center_of_gravity ==  [[L/2,W/2,H/2]]
