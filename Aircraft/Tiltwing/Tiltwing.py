...
def main():           
    ...
    if new_geometry :
        ...
        save_aircraft_geometry(vehicle , 'Tiltwing')
    else: 
        vehicle = load_aircraft_geometry('Tiltwing')
...
def vehicle_setup(redesign_rotors=True): 
    ...
    if redesign_rotors:
        ...
        save_rotor(prop_rotor, os.path.join(local_path, 'Tiltwing_rotor_geometry.res'))
    else: 
        loaded_prop_rotor = load_rotor(os.path.join(local_path, 'Tiltwing_rotor_geometry.res')) 
