...
from SUAVE.Methods.Weights.Buildups.eVTOL.empty_new                       import empty_new
...
def vehicle_setup():
    ...
    airfoil.polar_files            = ['Airfoils' + separator + 'Polars' + separator + 'NACA_4412_polar_Re_50000.txt' ,
                                   'Airfoils' + separator + 'Polars' + separator + 'NACA_4412_polar_Re_100000.txt' ,
                                   'Airfoils' + separator + 'Polars' + separator + 'NACA_4412_polar_Re_200000.txt' ,
                                    'Airfoils' + separator + 'Polars' + separator + 'NACA_4412_polar_Re_500000.txt' ,
                                   'Airfoils' + separator + 'Polars' + separator + 'NACA_4412_polar_Re_1000000.txt' ] 
    ...
    vehicle.weight_breakdown  = empty_new(vehicle,settings=Data())    
