...
def validation():  
    ...
    power_Boeing_502_14 , thermal_efficiency_Boeing_502_14, PSFC_Boeing_502_14 = turboshaft_engine_Boeing_502_14(altitude,mach) 
    power_General_Electric_T64 , thermal_efficiency_General_Electric_T64, PSFC_General_Electric_T64 = turboshaft_engine_General_Electric_T64(altitude,mach)
    
    print(power_Boeing_502_14, thermal_efficiency_Boeing_502_14, PSFC_Boeing_502_14)
    
    print(power_General_Electric_T64, thermal_efficiency_General_Electric_T64, PSFC_General_Electric_T64)    
...
def turboshaft_engine_General_Electric_T64(altitude,mach):   
    ...
    turboshaft.tag                                 = 'Turboshaft_propulsor'
    turboshaft.origin                              = [[13.72, 4.86,-1.1]] 
    turboshaft.engine_length                       = 2.007     
    turboshaft.bypass_ratio                        = 0    
    turboshaft.design_altitude                     = 0.01*Units.ft
    turboshaft.design_mach_number                  = 0.01   
    turboshaft.design_power                        = 3228880.0*Units.W 
    turboshaft.mass_flow_rate_design               = 1.9 #[kg/s]
    ...
    compressor.tag                                 = 'compressor'
    compressor.polytropic_efficiency               = 0.91
    compressor.pressure_ratio                      = 14.9  
    compressor.mass_flow_rate                      = 1.9 
    turboshaft.compressor                          = compressor
    ...
    combustor.efficiency                           = 0.99 
    combustor.alphac                               = 1.0     
    combustor.turbine_inlet_temperature            = 911.15
    combustor.pressure_ratio                       = 0.95
    combustor.fuel_data                            = RCAIDE.Library.Attributes.Propellants.Jet_A()  
    turboshaft.combustor                           = combustor
