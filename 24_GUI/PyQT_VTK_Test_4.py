...
def B777_vehicle_setup():
    ...
    wing.percent_span_root_offset         = 6.2 / 2
    ...
    outboard_flap                         = RCAIDE.Library.Components.Wings.Control_Surfaces.Flap()
    outboard_flap.tag                     = 'outboard_flap'
    outboard_flap.span_fraction_start     = 0.4
    outboard_flap.span_fraction_end       = 0.8
    outboard_flap.deflection              = 0.0 * Units.degrees
    outboard_flap.configuration_type      = 'double_slotted'
    outboard_flap.chord_fraction          = 0.30
    wing.append_control_surface(outboard_flap) 
    ...
    wing.percent_span_root_offset = 6.2 / 4
    ...
    wing.aspect_ratio            = (wing.spans.projected ** 2) /  wing.areas.reference 
    wing.taper                   = wing.chords.tip  / wing.chords.root
    wing.chords.mean_aerodynamic = 9.43826157 /2 # Incorect   
    wing.areas.exposed           = 2*wing.areas.reference *0.9
    wing.areas.wetted            = 2*wing.areas.reference *0.9 
    wing.aspect_ratio            = (wing.spans.projected ** 2) /  wing.areas.reference 
    ...
    turbofan.mass_properties.mass               = 7,893
    turbofan.engine_length                      = 7.29
    turbofan.bypass_ratio                       = 9
    turbofan.design_altitude                    = 35000.0*Units.ft
    turbofan.design_mach_number                 = 0.78   
    turbofan.design_thrust                      = 432.8 * Units.N # NOT CORRECT  
