...
def base_vehicle_setup() :
    ...
    propeller.cruise.design_thrust              = 2000  # 850  
    ...
    airfoil.polar_files                         = ['..' + separator + 'Airfoils' + separator + 'Polars' + separator +'NACA_4412_polar_Re_50000.txt' ,
                                                   ...
                                                   '..' + separator + 'Airfoils' + separator + 'Polars' + separator +'NACA_4412_polar_Re_3500000.txt',
                                                   '..' + separator + 'Airfoils' + separator + 'Polars' + separator +'NACA_4412_polar_Re_5000000.txt',
                                                   '..' + separator + 'Airfoils' + separator + 'Polars' + separator +'NACA_4412_polar_Re_7500000.txt' ]
