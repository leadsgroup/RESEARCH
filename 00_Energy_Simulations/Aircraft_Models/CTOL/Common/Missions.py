...
#   Full Mission 1500
# ------------------------------------------------------------------
def full_mission_setup_at_1500ft(analyses,simulated_days = 1,flights_per_day = 1,control_points = 10,recharge_battery = True,microphone_terrain_data = None ,airport_geospacial_data = None): 
    ...
    mission     = MARC.Analyses.Mission.Sequential_Segments()
    mission.tag = 'full_mission_setup_at_1500ft'
...
#   Full Mission 1500
# ------------------------------------------------------------------
def full_mission_setup_at_2000ft(analyses,simulated_days = 1,flights_per_day = 1,control_points = 10,recharge_battery = True,microphone_terrain_data = None ,airport_geospacial_data = None): 
    ...
    mission     = MARC.Analyses.Mission.Sequential_Segments()
    mission.tag = 'full_mission_setup_at_2000ft'
...
def constant_elevation_in_cruise_mission_setup(analyses,vehicle,simulated_days = 1,flights_per_day = 1,control_points = 10,recharge_battery = True,microphone_terrain_data = None ,airport_geospacial_data = None):
    ...
    segment.friction_coefficient                             = 0.04 
    segment.state.unknowns.time                              = 10.            
    segment.altitude                                         = 0.0  + airport_geospacial_data.departure_location[2]
    segment.true_course_angle                                = airport_geospacial_data.true_course_angle   
    segment.battery_energy                                   = vehicle.networks.battery_electric_rotor.battery.pack.max_energy    
    segment = vehicle.networks.battery_electric_rotor.add_unknowns_and_residuals_to_segment(segment)         
    mission.append_segment(segment) 
    ...
    segment.tag = 'Departure_End_of_Runway'       
    segment.analyses.extend( analyses.base )           
    segment.altitude_start                                   = 0.0 * Units.feet+ airport_geospacial_data.departure_location[2]
    segment.altitude_end                                     = 50.0 * Units.feet+ airport_geospacial_data.departure_location[2]
    segment.air_speed_start                                  = Vstall  
    segment.air_speed_end                                    = Vstall*1.1        
    segment.climb_rate                                       = 600 * Units['ft/min'] 
    segment.true_course_angle                                = airport_geospacial_data.true_course_angle    
    ...
    segment.tag = 'Initial_CLimb_Area'  
    segment.analyses.extend( analyses.base )   
    segment.altitude_start                                   = 50.0 * Units.feet+ airport_geospacial_data.departure_location[2]
    segment.altitude_end                                     = 500.0 * Units.feet+ airport_geospacial_data.departure_location[2]
    segment.air_speed_start                                  = Vstall*1.1     
    segment.air_speed_end                                    = Vstall*1.2  
    segment.climb_rate                                       = 600 * Units['ft/min']  
    segment.true_course_angle                                = airport_geospacial_data.true_course_angle    
    ...
    segment.tag = 'Climb'       
    segment.analyses.extend( analyses.base )         
    segment.altitude_start                                   = 500.0 * Units.feet+ airport_geospacial_data.departure_location[2]
    segment.altitude_end                                     = 1500 * Units.feet + airport_geospacial_data.departure_location[2]
    segment.air_speed_start                                  = Vstall*1.2  
    segment.air_speed_end                                    = 130.* Units['mph']    
    segment.climb_rate                                       = 500* Units['ft/min']
    segment.true_course_angle                                = airport_geospacial_data.true_course_angle       
    ...
    segment.analyses.extend( analyses.forward_flight)   
    segment.altitude_start                           = 2500.0 * Units.ft + airport_geospacial_data.departure_location[2]  
    segment.altitude_end                             = 2500.0 * Units.ft   + airport_geospacial_data.destination_location[2]  
    segment.air_speed                                = 130.  * Units['mph'] 
    cruise_distance                                  = airport_geospacial_data.flight_range - 31.5615*Units.nmi   
    segment.distance                                 = cruise_distance   
    segment.true_course_angle                        = airport_geospacial_data.true_course_angle   
    ...
    segment.tag = 'Descent'   
    segment.analyses.extend( analyses.base )       
    segment.altitude_start                                   = 1500 * Units.feet  + airport_geospacial_data.destination_location[2]  
    segment.altitude_end                                     = 1000.0 * Units.feet+ airport_geospacial_data.destination_location[2]  
    segment.air_speed_start                                  = 130.* Units['mph']    
    segment.air_speed_end                                    = Vstall*1.3
    segment.climb_rate                                       = -300 * Units['ft/min']
    segment.true_course_angle                                = airport_geospacial_data.true_course_angle      
    ...
    segment.tag = 'Baseleg' 
    segment.analyses.extend( analyses.base)   
    segment.altitude_start                                   = 1000 * Units.feet+ airport_geospacial_data.destination_location[2]  
    segment.altitude_end                                     = 500.0 * Units.feet+ airport_geospacial_data.destination_location[2]  
    segment.air_speed_start                                  = Vstall*1.2  
    segment.air_speed_end                                    = Vstall*1.1  
    segment.climb_rate                                       = -300 * Units['ft/min'] 
    segment.true_course_angle                                = airport_geospacial_data.true_course_angle   
    ...
    segment.tag = segment_name          
    segment.analyses.extend( analyses.base)            
    segment.altitude_start                                   = 500.0 * Units.feet+ airport_geospacial_data.destination_location[2]  
    segment.altitude_end                                     = 00.0 * Units.feet+ airport_geospacial_data.destination_location[2]  
    segment.air_speed_start                                  = Vstall*1.1  
    segment.air_speed_end                                    = Vstall 
    segment.climb_rate                                       = -300 * Units['ft/min'] 
    segment.state.unknowns.throttle                          =  0.8 * ones_row(1)   
