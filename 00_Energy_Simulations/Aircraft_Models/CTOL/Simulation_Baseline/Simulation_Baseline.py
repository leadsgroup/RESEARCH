...
def main():  
    ...
    if RUN_NEW_MODEL_FLAG:    
        ...
        meta_data = Data(
            ...
            true_course_angle                       = 30.0*Units.degrees,
        ...
        # -------------------------------------------------------------------------------------------    
        base_mission      = Missions.baseline_mission_setup(configs_analyses,simulated_days,flights_per_day,control_points,recharge_battery,meta_data)
