...
import pylab as plt 
import sys 
sys.path.append('../../Aircraft_Models/Tiltwing/Common')  
...
def main():  
    ...
    departure_location         = ['LAX','SNA','BUR','LAX','BUR','LAX']
    
    # coordinates for departure airport 
    departure_coord            = np.array([[ 33.94506045,-118.4106796 ],
                                           [ 33.66558366,-117.8490798],
                                           [34.19318238,-118.3541369],
                                           [ 33.94506045,-118.4106796 ],
                                           [34.19318238,-118.3541369],
                                           [ 33.94506045,-118.4106796 ],])
    
    # destination airport location
    destination_location       = ['SBD','ONT','ONT','BUR','DIS','DIS']
    
    # coordinates for destination airport 
    destination_coord          = np.array([[34.09450676,-117.2165165],
                                           [34.07804963,-117.5841318],
                                           [34.07804963,-117.5841318],
                                           [34.19318238,-118.3541369],
                                           [33.81151014,-117.9179886 ],
                                           [ 33.81151014,-117.9179886]])
    ...
    adjusted_cruise_distance     = np.array([8.46,
                                             8.3,
                                             6.61,
                                             7.18,
                                             7.93,
    ...
    if RUN_NEW_MODEL_FLAG:     
        for leg in range(len(departure_location)):   
            ...
            # SAVE RESULTS
            # -------------------------------------------------------------------------------------------
            filename          = 'LA_TW_1000ft_mission_' + city + '_' +  departure_location[leg] + '_to_' + destination_location[leg]
