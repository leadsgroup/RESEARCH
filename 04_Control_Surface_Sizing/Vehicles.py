...
import numpy as np    
from MARC.Plots.Performance.Mission_Plots                                   import *  
...
def vehicle_setup():
    ...
    1) center of gravity (either hard coded or use MARC's built in function)
    ...
    tip_airfoil.coordinate_file           = '..' + separator + 'Airfoils' + separator + 'NACA_6410.txt' 
 
    root_airfoil                          = MARC.Components.Airfoils.Airfoil()
    root_airfoil.coordinate_file          = '..' + separator + 'Airfoils' + separator + 'NACA_4415.txt'  
    # add to vehicle
    ...
    prop.origin                                = [[-0.1, 0, 0]] 
    prop.airfoil_geometry                      =  ['..' + separator + 'Airfoils' + separator + 'NACA_4412.txt'] 
    prop.airfoil_polars                        = [['..' + separator + 'Airfoils' + separator + 'Polars' + separator +'NACA_4412_polar_Re_50000.txt' ,
...
def aileron_rudder_sizing_setup(vehicle):    
    ...
    if vehicle.rudder_flag:
        ...
        rudder                       = MARC.Components.Wings.Control_Surfaces.Rudder()
        rudder.tag                   = 'rudder'
