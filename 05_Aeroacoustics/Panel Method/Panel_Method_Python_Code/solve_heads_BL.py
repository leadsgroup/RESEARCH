...
# heads_method.py 
# ----------------------------------------------------------------------    
def solve_heads_BL(l,del_0,theta_0,delta_star_0,Re_L,x_i,Ve_i,dVe_i):    
    ''' Solved intergral boundary layer equations for turbulent flow  
    '''   

    nu           = l/Re_L            
    H_0          = delta_star_0 / theta_0                        # page 126 
    ...
    return x_i,H,delta_star,delta,cf,theta,Re_x,Re_theta  
