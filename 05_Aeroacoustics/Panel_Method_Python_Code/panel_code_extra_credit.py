########################################################################
#
#  panel_code_test.py - Create surface panelization for a NACA4 Series Airfoil
#
#
#  Input list: 
#  N/A
...
from Boundary_Layer_Code.solve_thwaites_BL import solve_thwaites_BL
from Boundary_Layer_Code.solve_heads_BL import solve_heads_BL
from Boundary_Layer_Code.michel_criterion import michel_criterion
...
def main():
    ...
    x_lam_top,H_lam_top,delta_star_lam_top,delta_lam_top,cf_lam_top,theta_lam_top,Re_x_lam_top,Re_theta_lam_top = \
        solve_thwaites_BL(x_bl_top[-1],Re_L,x_bl_top,Ve_top,dVe_top,theta_0_init) 
    ...
    x_lam_bot,H_lam_bot,delta_star_lam_bot,delta_lam_bot,cf_lam_bot,theta_lam_bot,Re_x_lam_bot,Re_theta_lam_bot =\
        solve_thwaites_BL(x_bl_bot[-1],Re_L,x_bl_bot,Ve_bot,dVe_bot,theta_0_init) 
