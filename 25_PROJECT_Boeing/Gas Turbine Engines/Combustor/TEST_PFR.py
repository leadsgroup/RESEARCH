...
for n in range(n_steps):
    ...
    EI_CO_PFR.append((mdot_CO_PFR * 1000) / mdot_fuel_PFR[n] if mdot_fuel_PFR[n] > 0 else 0)
    ...
    EI_NO2_PFR.append((mdot_NO2_PFR * 1000) / mdot_fuel_PFR[n] if mdot_fuel_PFR[n] > 0 else 0)
    ...
    EI_NO_PFR.append((mdot_NO_PFR * 1000) / mdot_fuel_PFR[n] if mdot_fuel_PFR[n] > 0 else 0)
