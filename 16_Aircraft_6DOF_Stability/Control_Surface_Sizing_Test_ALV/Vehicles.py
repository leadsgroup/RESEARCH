...
def vehicle_setup():
    ...
    vehicle.flight_envelope.design_mach_number        = 0.13 
    vehicle.passengers                                = 2 
    vehicle.design_dynamic_pressure                   = 1929.16080736607

    #vehicle.flight_envelope.stick_fixed_trim_angle_of_attack    = 0     
    #vehicle.flight_envelope.pull_up_trim_angle_of_attack        = 0     
    #vehicle.flight_envelope.push_over_trim_angle_of_attack      = 0       
    ...
    fuselage.lengths.nose                       = fuselage.lengths.total / 5
    fuselage.lengths.tail                       =  fuselage.lengths.total / 5
    fuselage.width                              = 1.22028016 
    fuselage.heights.maximum                    = 1.634415138  
    fuselage.areas.wetted                       = 56.5
    fuselage.areas.front_projected              = fuselage.width*fuselage.heights.maximum
    fuselage.effective_diameter                 = 1.22028016 
    fuselage.lengths.empennage                  = 1 
